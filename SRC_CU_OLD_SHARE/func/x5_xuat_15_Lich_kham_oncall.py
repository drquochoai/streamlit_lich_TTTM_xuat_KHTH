...
def xuat(tenFileDeXuatHienTai):
    """
        Xuất file "1.5. Lịch khám oncall các Chuyên khoa Khu tiêu chuẩn"
    ...
    # SHOW 2
    if showStep:
        st.markdown("rename columns to name_KHTH")
        st.write(all_CLS_data)
    # END 2
...
if __name__ == "__main__":
    xuat("1.5. Lịch khám oncall các Chuyên khoa Khu tiêu chuẩn")
